$(document).ready(function(){
	...
	vis.append('circle').attr('id', '1').attr('class', 'point').attr('r', 6).attr('cx', 270).attr('cy', 155);

	graph.node.insert({id: '1', label: 'START', x: 240, y: 110, note: ''});
	vis.append('circle').attr('id', '2').attr('class', 'point').attr('r', 6).attr('cx', 270).attr('cy', 190);

	graph.node.insert({id: '2', label: 'N2', x: 270, y: 190, note: ''});
	vis.append('circle').attr('id', '3').attr('class', 'point').attr('r', 6).attr('cx', 270).attr('cy', 270);

	graph.node.insert({id: '3', label: 'N3', x: 270, y: 270, note: ''});
	vis.append('circle').attr('id', '4').attr('class', 'point').attr('r', 6).attr('cx', 270).attr('cy', 360);

	graph.node.insert({id: '4', label: 'N4', x: 270, y: 360, note: ''});
	
	vis.append('circle').attr('id', '5').attr('class', 'point').attr('r', 6).attr('cx', 270).attr('cy', 460);

	graph.node.insert({id: '5', label: 'N5', x: 270, y: 460, note: ''});
	
	vis.append('circle').attr('id', '6').attr('class', 'point').attr('r', 6).attr('cx', 270).attr('cy', 520);

	graph.node.insert({id: '6', label: 'N6', x: 270, y: 540, note: ''});
	
	vis.append('circle').attr('id', '7').attr('class', 'point').attr('r', 6).attr('cx', 270).attr('cy', 580);

	graph.node.insert({id: '7', label: 'N7', x: 270, y: 580, note: ''});
	
	vis.append('circle').attr('id', '8').attr('class', 'point').attr('r', 6).attr('cx', 460).attr('cy', 580);

	graph.node.insert({id: '8', label: 'N8', x: 460, y: 580, note: ''});
	vis.append('circle').attr('id', '9').attr('class', 'point').attr('r', 6).attr('cx', 340).attr('cy', 155);

	graph.node.insert({id: '9', label: 'N9', x: 340, y: 155, note: ''});
	vis.append('circle').attr('id', '10').attr('class', 'point').attr('r', 6).attr('cx', 440).attr('cy', 155);

	graph.node.insert({id: '10', label: 'N10', x: 440, y: 155, note: ''});
	vis.append('circle').attr('id', '11').attr('class', 'point').attr('r', 6).attr('cx', 530).attr('cy', 155);

	graph.node.insert({id: '11', label: 'N11', x: 530, y: 155, note: ''});
	vis.append('circle').attr('id', '12').attr('class', 'point').attr('r', 6).attr('cx', 580).attr('cy', 155);

	graph.node.insert({id: '12', label: 'N12', x: 580, y: 155, note: ''});
	vis.append('circle').attr('id', '13').attr('class', 'point').attr('r', 6).attr('cx', 610).attr('cy', 155);

	graph.node.insert({id: '13', label: 'N13', x: 610, y: 155, note: ''});
	vis.append('circle').attr('id', '14').attr('class', 'point').attr('r', 6).attr('cx', 700).attr('cy', 135);

	graph.node.insert({id: '14', label: 'N14', x: 700, y: 135, note: ''});
	vis.append('circle').attr('id', '15').attr('class', 'point').attr('r', 6).attr('cx', 760).attr('cy', 135);

	graph.node.insert({id: '15', label: 'N15', x: 760, y: 135, note: ''});
	vis.append('circle').attr('id', '16').attr('class', 'point').attr('r', 6).attr('cx', 810).attr('cy', 115);

	graph.node.insert({id: '16', label: 'N16', x: 810, y: 115, note: ''});
	vis.append('circle').attr('id', '17').attr('class', 'point').attr('r', 6).attr('cx', 840).attr('cy', 115);

	graph.node.insert({id: '17', label: 'N17', x: 840, y: 115, note: ''});
	vis.append('circle').attr('id', '18').attr('class', 'point').attr('r', 6).attr('cx', 990).attr('cy', 115);

	graph.node.insert({id: '18', label: 'N18', x: 990, y: 115, note: ''});
	...
	vis.append("line").attr('id', 'A1').attr('class', 'allLine').attr('x1', 270).attr('y1', 155).attr('x2', 270).attr('y2', 190).attr('stroke', 'black');

	graph.arch.insert({id: 'A1', start: 'START', end: 'N2', len: 100, note: ''});
	 vis.append("line").attr('id', 'A2').attr('class', 'allLine').attr('x1', 270).attr('y1', 190).attr('x2', 270).attr('y2', 270).attr('stroke', 'black');

	 graph.arch.insert({id: 'A2', start: 'N2', end: 'N3', len: 165, note: ''});

 vis.append("line").attr('id', 'A3').attr('class', 'allLine').attr('x1', 270).attr('y1', 270).attr('x2', 270).attr('y2', 360).attr('stroke', 'black');

	 graph.arch.insert({id: 'A3', start: 'N3', end: 'N4', len: 105, note: ''});

	vis.append("line").attr('id', 'A4').attr('class', 'allLine').attr('x1', 270).attr('y1', 360).attr('x2', 270).attr('y2', 460).attr('stroke', 'black');

	 graph.arch.insert({id: 'A4', start: 'N4', end: 'N5', len: 100, note: ''});

 vis.append("line").attr('id', 'A5').attr('class', 'allLine').attr('x1', 270).attr('y1', 460).attr('x2', 270).attr('y2', 520).attr('stroke', 'black');

 graph.arch.insert({id: 'A5', start: 'N5', end: 'N6', len: 50, note: ''});

	 vis.append("line").attr('id', 'A6').attr('class', 'allLine').attr('x1', 270).attr('y1', 520).attr('x2', 270).attr('y2', 580).attr('stroke', 'black');

	 graph.arch.insert({id: 'A6', start: 'N6', end: 'N7', len: 105, note: ''});

	 vis.append("line").attr('id', 'A7').attr('class', 'allLine').attr('x1', 270).attr('y1', 580).attr('x2', 460).attr('y2', 580).attr('stroke', 'black');

	 graph.arch.insert({id: 'A7', start: 'N7', end: 'N8', len: 55, note: ''});

	 vis.append("line").attr('id', 'A8').attr('class', 'allLine').attr('x1', 270).attr('y1', 155).attr('x2', 340).attr('y2', 155).attr('stroke', 'black');

	graph.arch.insert({id: 'A8', start: 'START', end: 'N9', len: 50, note: ''});

	 vis.append("line").attr('id', 'A9').attr('class', 'allLine').attr('x1', 340).attr('y1', 155).attr('x2', 440).attr('y2', 155).attr('stroke', 'black');

	 graph.arch.insert({id: 'A9', start: 'N9', end: 'N10', len: 110, note: ''});

	 vis.append("line").attr('id', 'A10').attr('class', 'allLine').attr('x1', 440).attr('y1', 155).attr('x2', 530).attr('y2', 155).attr('stroke', 'black');

 graph.arch.insert({id: 'A10', start: 'N10', end: 'N11', len: 55, note: ''});

	vis.append("line").attr('id', 'A11').attr('class', 'allLine').attr('x1', 530).attr('y1', 155).attr('x2', 580).attr('y2', 155).attr('stroke', 'black');

	 graph.arch.insert({id: 'A11', start: 'N11', end: 'N12', len: 55, note: ''});

	vis.append("line").attr('id', 'A12').attr('class', 'allLine').attr('x1', 580).attr('y1', 155).attr('x2', 610).attr('y2', 155).attr('stroke', 'black');

	graph.arch.insert({id: 'A12', start: 'N12', end: 'N13', len: 55, note: ''});

	 vis.append("line").attr('id', 'A13').attr('class', 'allLine').attr('x1', 610).attr('y1', 155).attr('x2', 700).attr('y2', 135).attr('stroke', 'black');

	 graph.arch.insert({id: 'A13', start: 'N13', end: 'N14', len: 55, note: ''});

	vis.append("line").attr('id', 'A14').attr('class', 'allLine').attr('x1', 700).attr('y1', 135).attr('x2', 760).attr('y2', 135).attr('stroke', 'black');

	 graph.arch.insert({id: 'A14', start: 'N14', end: 'N15', len: 55, note: ''});

	 vis.append("line").attr('id', 'A15').attr('class', 'allLine').attr('x1', 760).attr('y1', 135).attr('x2', 810).attr('y2', 115).attr('stroke', 'black');

	 graph.arch.insert({id: 'A15', start: 'N15', end: 'N16', len: 60, note: ''});

	 vis.append("line").attr('id', 'A16').attr('class', 'allLine').attr('x1', 810).attr('y1', 115).attr('x2', 840).attr('y2', 115).attr('stroke', 'black');

	 graph.arch.insert({id: 'A16', start: 'N16', end: 'N17', len: 55, note: ''});

vis.append("line").attr('id', 'A17').attr('class', 'allLine').attr('x1', 840).attr('y1', 115).attr('x2', 990).attr('y2', 115).attr('stroke', 'black');

	 graph.arch.insert({id: 'A17', start: 'N17', end: 'N18', len: 110, note: ''});

	 vis.append("line").attr('id', 'A18').attr('class', 'allLine').attr('x1', 990).attr('y1', 115).attr('x2', 990).attr('y2', 370).attr('stroke', 'black');
