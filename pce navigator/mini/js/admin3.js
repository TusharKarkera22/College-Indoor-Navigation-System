$(document).ready(function(){
	...
	$(".closetut").click(function(){
		...
		$('#tutorial4').css("display", "none");
		$('#tutorial5').css("display", "none");
		$('#tutorial6').css("display", "none");
		$('#tutorial7').css("display", "none");
	});

	$("#totut2").click(function() {
		$('#tutorial1').css("display", "none");
	...
	$("#totut3").click(function() {
		...
		$('#p1t3').css("display", "block");

		$("#admininterface").click(function(){
			$('#p1t3').css("text-decoration", "line-through");
			$('#p2t3').css("display", "block");
		});

		$("#node").click(function(){
			$('#p2t3').css("text-decoration", "line-through");
			$('#p3t3').css("display", "block");
		});

		$("#newnode").click(function(){
			$('#p3t3').css("text-decoration", "line-through");
			$('#p4t3').css("display", "block");
		});

		$("#savenode").click(function(){ 
			$('#p4t3').css("text-decoration", "line-through");
			$('#p5t3').css("display", "block");
		});
	});

	
	$("#totut4").click(function() { 
		var h = 1;
		$('#tutorial3').css("display", "none");
		$('#tutorial4').css("display", "block");
		$('#p1t4').css("display", "block");

		$("#node").click(function(){
			$('#p1t4').css("text-decoration", "line-through");
			$('#p2t4').css("display", "block");
		});

		$("#modnode").click(function(){
			$('#p2t4').css("text-decoration", "line-through");
			$('#p3t4').css("display", "block");
		});

		$("#modifySelNode").click(function(){
			$('#p3t4').css("text-decoration", "line-through");
			$('#p4t4').css("display", "block");
		});

		$("#prevtut").click(function(){
			$("#remembernode").css("display", "block");
		});

		$("#savenode").click(function(){
			if (h > 2) {
				$('#p4t4').css("text-decoration", "line-through");
				$('#p5t4').css("display", "block");
			} else {
				h++;
	...
	$("#totut5").click(function() {
		var lol = 0; 
		$('#tutorial4').css("display", "none");
		$('#tutorial5').css("display", "block");
		$('#p1t5').css("display", "block");

		$("#arch").click(function(){
			$('#p1t5').css("text-decoration", "line-through");
			$('#p2t5').css("display", "block");
		});

		$("#newarch").click(function(){
			$('#p2t5').css("text-decoration", "line-through");
			$('#p3t5').css("display", "block");
		});

		$("#selStaNode").click(function(){
			$('#p3t5').css("text-decoration", "line-through");
			$('#p4t5').css("display", "block");
		});

		$("#selEndNode").click(function(){
			$('#p4t5').css("text-decoration", "line-through");
			$('#p5t5').css("display", "block");
		});

		$("#calLength").click(function(){
			$('#p5t5').css("text-decoration", "line-through");
			$('#p6t5').css("display", "block");
		});

		$("#savearch").click(function(){
			if (lol == 0) {
				$('#p6t5').css("text-decoration", "line-through");
				$('#p7t5').css("display", "block");
				lol++;
			} else if (lol > 3) {
				$('#p7t5').css("text-decoration", "line-through");
				$('#p8t5').css("display", "block");
			} else {
				lol++;
			}
		});
	...
	$("#totut6").click(function(){
		$('#tutorial5').css("display", "none");
		$('#tutorial6').css("display", "block");
		$('#p1t6').css("display", "block");

		$("#arch").click(function(){
			$('#p1t6').css("text-decoration", "line-through");
			$('#p2t6').css("display", "block");
		});

		$("#modarch").click(function(){
			$('#p2t6').css("text-decoration", "line-through");
			$('#p3t6').css("display", "block");
		});

		$("#deleteSelArch").click(function(){
			$('#p3t6').css("text-decoration", "line-through");
			$('#p4t6').css("display", "block");
		})
	});

	$("#totut7").click(function(){
		$('#tutorial6').css("display", "none");
		$('#tutorial7').css("display", "block");
		$('#p1t7').css("display", "block");

		$("#choiseinterface").click(function(){
			$('#p1t7').css("text-decoration", "line-through");
			$('#p2t7').css("display", "block");
		});

		$("#userinterface").click(function(){
			$('#p2t7').css("text-decoration", "line-through");
			$('#p3t7').css("display", "block");
		});

		$("#USERselStaNode").click(function(){
			$('#p3t7').css("text-decoration", "line-through");
			$('#p4t7').css("display", "block");
		});

		$("#USERselEndNode").click(function(){
			$('#p4t7').css("text-decoration", "line-through");
			$('#p5t7').css("display", "block");
		});

		$("#calculatePath").click(function(){
			$('#p5t7').css("text-decoration", "line-through");
			$('#p6t7').css("display", "block");
		});
	});
	/* END TUTORIAL JS */
